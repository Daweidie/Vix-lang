...
while.cond0:                                      ; preds = %if.end5, %entry
...
while.body1:                                      ; preds = %while.cond0
  ...
  %cmp5 = icmp eq i32 %load4, 3
  %bool6 = zext i1 %cmp5 to i32
  %cond7 = icmp ne i32 %bool6, 0
  br i1 %cond7, label %if.then3, label %if.else4

while.end2:                                       ; preds = %if.then3, %while.cond0
...
if.end5:                                          ; preds = %if.else4
  %load8 = load i32, ptr %i, align 4
  %1 = call i32 (ptr, ...) @printf(ptr @.fmt.i32, i32 %load8)
