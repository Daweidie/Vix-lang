...
EXPECT: Dict[str, Expectation] = {
    ...
    "test4.vix": Expectation(False, compile_error_contains="expected type"),
    "test7.vix": Expectation(False, compile_error_contains="expected type"),
    "test8.vix": Expectation(False, compile_error_contains="expected type"),
    "test11.vix": Expectation(False, compile_error_contains="self-recursive struct fields"),
    "test12.vix": Expectation(False, compile_error_contains="has no member named"),
    ...
    "test52.vix": Expectation(False, compile_error_contains="undefined function"),
    ...
    "test160.vix": Expectation(False, compile_error_contains="undefined function"),
    ...
    "test182.vix": Expectation(True, run_output=["hello", "100", "78.500000", "large"]),
