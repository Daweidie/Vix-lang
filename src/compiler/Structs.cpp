...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::visitStructDef(ASTNode* node) {
...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::visitStructLiteral(ASTNode* node) {
...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::handleArrayLength(ASTNode* object) {
...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::visitMemberAccess(ASTNode* node) {
...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::visitStructAssign(ASTNode* node) {
...
void LLVMCodeGenerator::initStructLiteral(AllocaInst* structAlloc, ASTNode* node) {
...
LLVMCodeGenerator::VisitResult LLVMCodeGenerator::visitMemberAssign(ASTNode* node) {
    if (!node || node->type != AST_ASSIGN) return VisitResult();
